...
- [ ] api/webhooks/payment_success to api/webhooks/mercadopago
- [ ] Images optimization
- [ ] Videos optimization
- [ ] Change image names to lowercase
- [ ] Change components names to middle dash or camel case (choose one)
- [ ] Add favicon, maybe an ant? (Recommended tool: [https://realfavicongenerator.net](https://realfavicongenerator.net))
- [ ] Change imports to absolute with @/...
