...
const Introduction = () => {
    return (
        <section className='w-auto bg-red-700
                ...
                <div className='pt-2 mb-10 text-4xl font-bold ml-8
                ...
                <div className='flex flex-col justify-end items-end
                                lg:justify-center lg:items-center text-xl'>
                    <span className='w-[700px] mb-5 text-center'>La falta de tiempo para trasladarte de tu casa a un gimnasio, ya sea por
                    ...
                    <span className='w-[700px] mb-5 text-center'>Elegí entre mis desafíos o planificaciones online y da el paso que cambiara tu
                                                        vida para siempre.
                    </span>
                </div>
        </section>
