                    ...
                    <div className='flex flex-row pb-20'>
                        <div className='w-3/6'>
                            <Image
                                ...
                                alt='line'
                                fill
                                className='relative w-[700px] ml-20 h-[700px] object-cover p-8 rounded-full'
                            /> 
                        </div>
                        <div className='w-3/6 flex flex-col justify-center items-center text-2xl'>
                            <div className='flex justify-center items-center w-[350px] ml-auto mr-auto'>
