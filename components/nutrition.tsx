    ...
    return (
        <>
            <Container className='w-full h-[750px]' id='guianutricional'>
                    <div className='flex w-4 lg:w-full'>
                        <h1 className='text-white text-5xl font-bold mt-20 mb-10
                                        lg:text-6xl lg:w-full lg:text-center lg:mr-8 lg:mt-36'
                    >Guia Nutricional Basica.</h1>
                    </div>
                    <div className='w-[280px] lg:w-3/6 lg:mt-28 lg:mx-auto'>
