...
const About = () => {
    ...
    return (
        <>
            <section className='w-full h-auto bg-white pt-20 lg:pt-36' id='quiensoy'>
                <div className='flex w-18 justify-end pr-28'>
                    <div className='flex flex-col'>
                        ...
                        <h1 className='mt-4 lg:ml-10 text-black text-3xl font-bold
                                    lg:text-6xl'
                        >¿QUIÉN SOY?</h1>
                    </div>
                </div>
                {isMobile ? (
                    <div className='flex flex-col pb-8'>
                        <div className='flex justify-center items-center w-[85%] ml-auto mr-auto'>
